...
import brashmonkey.spriter.Entity.ObjectType;
import brashmonkey.spriter.Timeline.Key.Bone;
import brashmonkey.spriter.Timeline.Key.Object;

/**
 * A Drawer is responsible for drawing a {@link GDXPlayer}.
 ...
 * Anyone who wants to draw a {@link GDXPlayer} has to know how to draw a resource. A resource can be e.g. a sprite, a texture or a texture region.
 * To draw a {@link GDXPlayer} call {@link #draw(GDXPlayer)}. This method relies on {@link #draw(Object)}, which has to be implemented with the chosen backend.
 * To debug draw a {@link GDXPlayer} call {@link #drawBones(GDXPlayer)}, {@link #drawBoxes(GDXPlayer)} and {@link #drawPoints(GDXPlayer)},
...
public abstract class Drawer<R> {
	 ...
	 */
	public void drawBones(GDXPlayer player){
	 ...
	 */
	public void drawBoxes(GDXPlayer player){
	 ...
	 */
	public void drawBoneBoxes(GDXPlayer player){
	 ...
	 */
	public void drawBoneBoxes(GDXPlayer player, Iterator<Bone> it){
		while(it.hasNext()){
			Bone bone = it.next();
	 ...
	 */
	public void drawObjectBoxes(GDXPlayer player){
	 ...
	 */
	public void drawObjectBoxes(GDXPlayer player, Iterator<Object> it){
		while(it.hasNext()){
			Object bone = it.next();
			this.drawBox(player.getBox(bone));
		}
	 ...
	 */
	public void drawPoints(GDXPlayer player){
	 ...
	 */
	public void drawPoints(GDXPlayer player, Iterator<Object> it){
		while(it.hasNext()){
	 ...
	 * @param player the player to draw
	 */
	public void draw(GDXPlayer player){
	 ...
	 */
	public void draw(GDXPlayer player, CharacterMap[] maps){
