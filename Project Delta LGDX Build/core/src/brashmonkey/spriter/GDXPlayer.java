...
import brashmonkey.spriter.Entity.CharacterMap;
import brashmonkey.spriter.Entity.ObjectInfo;
import brashmonkey.spriter.Mainline.Key.BoneRef;
import brashmonkey.spriter.Mainline.Key.ObjectRef;
import brashmonkey.spriter.Timeline.Key.Bone;
import brashmonkey.spriter.Timeline.Key.Object;
...
public class GDXPlayer {
	...
	/**
	 * Creates a {@link GDXPlayer} instance with the given entity.
	 * @param entity the entity this player will animate
	 */
	public GDXPlayer(Entity entity){
	 ...
	 */
	public GDXPlayer setTime(int time){
		this.time = time;
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setScale(float scale){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer scale(float scale){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer flip(boolean x, boolean y){
		if(x) this.flipX();
		if(y) this.flipY();
		return this;
	}
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setPosition(float x, float y){
		this.dirty = true;
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setPosition(Point position){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer translatePosition(float x, float y){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer translate(Point amount){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setAngle(float angle){
		this.dirty = true;
		this.angle = angle;
		return this;
	}
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer rotate(float angle){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setPivot(float x, float y){
		this.dirty = true;
		this.pivot.set(x, y);
		return this;
	}
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer setPivot(Point pivot){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer translatePivot(float x, float y){
	 ...
	 * @return this player to enable chained operations
	 */
	public GDXPlayer translatePivot(Point amount){
	...
	/**
	 * A listener to listen for specific events which can occur during the runtime of a {@link GDXPlayer} instance.
	 * @author Trixt0r
	 *
	 */
	public static interface PlayerListener{
		...
		/**
		 * Gets called if the current animation has reached it's end or it's beginning (depends on the current set {@link GDXPlayer#speed}).
		 ...
		 * If {@link GDXPlayer#setAnimation(Animation)} gets called and the new animation is the same as the previous one, this method will not be called.
		 ...
		 */
		public void preProcess(GDXPlayer player);
		
		/**
		 * Gets called after a player updated the current animation.
		 * @param player the player which is calling this method.
		 */
		public void postProcess(GDXPlayer player);
		
		/**
		 * Gets called if the mainline key gets changed.
		 * If {@link GDXPlayer#speed} is big enough it can happen that mainline keys between the previous and the new mainline key will be ignored.
	...
	/**
	 * An attachment is an abstract object which can be attached to a {@link GDXPlayer} object.
	 ...
	 * The {@link GDXPlayer} object will make sure that the attachment will be transformed relative to its {@link Attachment#parent}.
	 * @author Trixt0r
	 *
	 */
