...
/**
 * A player tweener is responsible for tweening to {@link GDXPlayer} instances.
 * Such a 
 * @author Trixt0r
 *
 */
public class PlayerTweener extends GDXPlayer{
	
	private TweenedAnimation anim;
	private GDXPlayer player1, player2;
	/**
	 * Indicates whether to update the {@link GDXPlayer} instances this instance is holding.
	 * If this variable is set to <code>false</code>, you will have to call {@link GDXPlayer#update()} on your own.
	 */
	 ...
	 */
	public PlayerTweener(GDXPlayer player1, GDXPlayer player2){
	...
	public PlayerTweener(Entity entity){
		this(new GDXPlayer(entity), new GDXPlayer(entity));
	}
	 ...
	 * @param player2 the second player
	 */
	public void setPlayers(GDXPlayer player1, GDXPlayer player2){
	 ...
	 */
	public GDXPlayer getFirstPlayer(){
		return this.player1;
	}
	 ...
	 */
	public GDXPlayer getSecondPlayer(){
		return this.player2;
	}
